...
7. **แพลนเมนู (`/admin/menus`)** — **ปฏิทินรายเดือน** (จ–ศ): กดวัน → ชื่อเมนู + **คนเลือก** (เลือกจากรายชื่อสมาชิก หรือพิมพ์ชื่ออิสระเพิ่มเอง) + รูป + toggle วันหยุด; ปุ่ม print/share ปฏิทิน
   - คนเลือก: combobox ค้นรายชื่อสมาชิก + ตัวเลือก "พิมพ์ชื่อเอง" (free text) เมื่อไม่เจอบัญชี
