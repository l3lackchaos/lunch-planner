...
7. **จัดการสัปดาห์ (`/admin/week/[weekId]`)** — ตั้งราคา/วัน, ใส่เมนู จ–ศ (ชื่อ/รูป), เปลี่ยนสถานะ draft→open→closed→billed
8. **คิวชำระเงิน (`/admin/payments/[weekId]`)** — list รอตรวจ + ดูสลิป (signed URL) + ปุ่มยืนยัน/ปฏิเสธ(เหตุผล); สรุปจ่ายแล้ว/ค้าง/ยอดรวม
9. **สรุปแม่ครัว (`/admin/summary/[weekId]`)** — เลือกวัน → นับไข่แต่ละชนิด + หัว + รายการ note พิเศษ + ปุ่มคัดลอกข้อความ
